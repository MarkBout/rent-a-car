                    ...
                    <table class="table table-image text-white" id="employees" border="1">
                        ...
                        <?php foreach ($employees as $employee):?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button data-id="<?php echo $employee['idgebruikers']?>" class="btn btn-danger" id="delemployee" data-bs-toggle="modal" data-bs-target="#deleteemployeeModal" <?php if ($employee['idgebruikers'] == $_SESSION['gebruiker']['idgebruikers']): ?> disabled <?php endif;?>>
